        ...
        <div class="row">
          <div class="col-md-12 probootstrap-relative">
            <div>
              ...
              <a href='editTrainerProfile.php?id=<?php echo $id?>' class="probootstrap-owl-navigation"><button><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>Add Programs</button></a>            
            </div>  
