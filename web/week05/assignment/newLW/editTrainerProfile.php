        ...
        <div class="row">
          <div class="col-md-12 probootstrap-relative">
            <div>
              ...
              <a href='editTrainerProfile.php?id=<?php echo $id?>' class="probootstrap-heading mt0 mb5"><button><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>Add Programs</button></a>            
            </div>  
