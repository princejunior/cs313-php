...
<?php
  ...
  <main>
    <section id="next-section" class="probootstrap-section">
        <div class="container">
            <a href='editTrainerProfile.php?id=<?php echo $id?>' class="probootstrap-owl-navigation absolute right"><button><span class="glyphicon glyphicon-cog" aria-hidden="true"></span>Edit Content</button></a>
