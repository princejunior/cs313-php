...
<?php
    class bookItems {
      ...
      // Methods
      function set_name($trainersInfo) {
        $this->items += array($trainersInfo);
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    ...
                                    <a href="#" class="btn btn-primary" action="<?php set_name($trainers[0])?>">Add to Book <?php echo $trainers[0][2]?></a>
                                </div>
                            </div>
                        </div>
                    </div>
